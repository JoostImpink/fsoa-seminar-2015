...
var me = {
	...
	age: 28,
	hobbies: [  
		"coding", "work", "programming", "SAS", "debugging"  
	]
};
...
var me = {
	...
	ageBinner: function(cutoff) { return (this.age < cutoff) ? this.name + " is a young gun" : this.name + " is an old fart";}
};
...
// array of objects
var myStruct = [
	{ name: "Joost", age: 28, keywords: [ "UF", "SAS", "hot tub" ] },
	{ name: "Walter White", age: 52, keywords: [ "chemistry", "family man", "enterpreneur" ] }
];
